...
let calcScrollValue = ()=>{
    ...
    scrollProgress.style.background = `conic-gradient(#fff ${scrollValue}%,#0092e6 ${scrollValue}%)`;
};
...
// JavaScript pour afficher et cacher les modals
var showModalLinks = document.querySelectorAll(".readMore");
